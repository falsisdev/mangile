...
<template>
    <div class="max-w-4xl mx-auto">
        ...
        <Transition enter-active-class="transition duration-300 ease-out"
            ...
            <UButton v-if="showBackToTop" icon="i-lucide-arrow-up" size="xl" color="primary" variant="soft"
                class="fixed bottom-20 right-20 rounded-lg shadow-xl z-50" @click="scrollToTop" aria-label="Başa Dön" />
        </Transition>
    </div>
</template>