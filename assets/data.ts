export const data = {
  scans: {
    ...
    webtoontr: "Webtoon TR",
    araznovel: "Araz Novel",
    atikrost: "Atikrost",
    kedito: "Kedi.to",
    kuroimanga: "Kuroi Manga",
    mangaokusana: "Manga Okusana",
    clover: "Clover Manga",
    glory: "Glory Manga",
    guncelmanga: "Güncel Manga",
    mangadiyari: "Manga Diyarı",
    adonis: "Adonis Fansub",
    adumanga: "Adu Manga",
    mangaship: "Manga Ship",
    pijamalikoi: "Pijamalı Koi",
    raindrop: "Raindrop Fansub",
    sadscans: "Sad Scans"
  },
  status: [
    "Okunuyor",
