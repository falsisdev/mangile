<template>
  <article class="prose my-10 max-w-none">
    <h1 class="font-bold">Hakkımızda</h1>
    <p class="text-lg">
    ...
    <p>
      ...
      bu web sitesinin ismi Mangile?<br />
      Bilmem, salladım.<br />
      ...
      geldiğinde
      <a href="https://nuxt.com" class="link link-success">Nuxt</a> henüz 2.
      ...
      <a href="https://vuejs.org" class="link link-success">Vue 3</a> hem
      <a href="https://vitejs.dev/" class="link link-warning">Vite</a>
      kullanan bu framework'ü Mangile için kullanmaya başladım. Daha sonra bir
      UI kütüphanesi kullanmam gerekti. Ben de bir süre
      <a href="https://next.vuetifyjs.com/en/" class="link link-accent"
        >Vuetify</a
      >
      mı kullansam diye düşünürken, Material 3'ün henüz web için
      yayınlanmadığını hatırlayıp
      <a href="http://tailwindcss.com/" class="link link-primary"
        >TailwindCSS</a
      >
      ...
      <a href="https://daisyui.com" class="link link-info">DaisyUI</a>
    ...
    <p>
      ...
      <RouterLink to="/contact" class="link">iletişim</RouterLink> sayfasına
      bakabilirsin. Sitenin Kullanıcı Arayüzü (UI) ile ilgili kafan karışıksa,
      <RouterLink to="/ui" class="link">şuradan</RouterLink> sitedeki
      işaretlerin ne anlama geldiğine bakabilirsin. İyi okumalar, sayanora!
    </p>
    <img
      class="shadow-lg rounded-lg"
